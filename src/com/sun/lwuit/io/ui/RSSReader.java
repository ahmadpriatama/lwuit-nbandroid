...
public class RSSReader extends List {
    ...
    public void sendRequest() {
        if(service == null) {
            ...
            if(blockList) {
                ...
                setModel(new DefaultListModel(new Object[] {progressTitle}));
            }
    ...
    private void updateComponentValues(Container root, Hashtable h) {
        ...
        for(int iter = 0 ; iter < c ; iter++) {
            ...
            if(current.getClass() == com.sun.lwuit.Container.class ||
                    current.getClass() == com.sun.lwuit.Tabs.class) {
    ...
    public Object getPropertyValue(String name) {
        ...
        if(name.equals("blockList")) {
            return new Boolean(blockList);
        }
        if(name.equals("progressTitle")) {
            return progressTitle;
        }
        if(name.equals("displayProgressPercentage")) {
            return new Boolean(displayProgressPercentage);
        }
