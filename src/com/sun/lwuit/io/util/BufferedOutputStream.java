...
public class BufferedOutputStream extends OutputStream {
    ...
    public BufferedOutputStream(OutputStream out, int size, String name) {
        ...
        streamCount++;
        this.name = name;
        IOImplementation.getInstance().logStreamCreate(name, false, streamCount);
    }
    ...
    public void close() throws IOException {
        if(!closed) {
            streamCount--;
            IOImplementation.getInstance().closingOutput(out);
            ...
            IOImplementation.getInstance().logStreamDoubleClose(name, false);
        }
    }
